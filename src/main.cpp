...
int64 nChainStartTime = 1411639793;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Civilization Coin Reborn - 25/09/2014";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1411639793;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2823820;
        ...
        assert(block.hashMerkleRoot == uint256("0x78a7cedbddff06f1748d996e7556bdfe4b61f21748d2b7787178873253ce084f"));
...
unsigned char pchMessageStart[4] = { 0xcf, 0xf2, 0xc1, 0xed };
